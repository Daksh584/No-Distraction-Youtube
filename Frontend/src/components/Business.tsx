...
function FeatureCard({ icon, title, content, index }: FeatureCardProps) {
  return (
    <div
      className="glass rounded-3xl p-6 sm:p-8 feature-card hover-lift animate-slide-up w-full"
...
export default function Business() {
  return (
    <section id="features" className="flex flex-col md:flex-row py-12 sm:py-16 items-center gap-12">
      <div className="flex-1 flex flex-col justify-center items-start animate-slide-up">
        <h2 className="font-poppins font-bold text-4xl sm:text-5xl lg:text-6xl leading-tight mb-6">
        ...
        <p className="font-sans text-lg text-base-content/70 max-w-[520px] leading-relaxed mb-8">
