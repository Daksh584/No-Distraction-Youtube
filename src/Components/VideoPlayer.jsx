              ...
              {isLoading ? (
                ...
                playlistItems.map((item, index) => (
                  <div
                    ...
                    className={`glass rounded-xl p-3 cursor-pointer hover-lift transition-all duration-300 ${item.snippet.resourceId.videoId === videoId ? 'ring-2 ring-primary-500 shadow-glow' : ''
                      }`}
                  ...
                  >
                    <div className="flex gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className={`font-poppins font-medium text-sm line-clamp-2 mb-1 ${item.snippet.resourceId.videoId === videoId ? 'text-primary-500' : 'text-base-content'
                          }`}>
                          {item.snippet.title}
                        </p>
